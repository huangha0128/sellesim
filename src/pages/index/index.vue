      ...
      <view class="hero-inner">
        <view class="hero-top">
          ...
          <view class="hero-avatar" @click="goProfile">
            <text class="avatar-emoji">{{ store.user.avatar }}</text>
          </view>
        </view>
        ...
        <view class="region-chips">
          ...
          >
            <text class="region-flag">{{ r.flag }}</text>
    ...
    <view class="content">
      <view class="section">
        ...
        <scroll-view scroll-x class="hot-scroll" :show-scrollbar="false">
          ...
          >
            <view class="hot-flag">
              <text class="hot-flag-emoji">{{ c.flag }}</text>
...
import { getPackages } from '@/mock/data'
